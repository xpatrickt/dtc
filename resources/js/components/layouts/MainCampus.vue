                        ...
                        <nav class="bd-links collapse" id="bd-docs-nav">
                            <div class="bd-toc-item">
                               <ul class="list-unstyled ps-0" style="font-size:20px;">
                                    ...
                                    <li class="mb-1" >
                                        <a class="nav-link" href="#" @click.prevent="redireccionar('BibliotecaVirtual')"> 
                                            <i class="fa fa-book  me-3"></i>Biblioteca Virtual
                                        </a>
                                    </li>
                                    <li class="mb-1" >
                                        <a class="nav-link" href="#" @click.prevent="redireccionar('ContenidoDigital')"> 
                                            <i class="fa fa-play me-3"></i>Contenido Digital
                                        </a>
                                    </li>
                                    <li class="mb-1" >
                                        <a class="nav-link" href="#" @click.prevent="redireccionar('ReunionVirtual')"> 
                                            <i class="fas fa-video"></i> Reunión Virtual
                                        </a>
                                    </li>
                                    <li class="mb-1" >
                                        <a class="nav-link" href="#" @click.prevent="redireccionar('EvaluacionVirtual')"> 
                                            <i class="fas fa-file-signature"></i> Evaluación Virtual
                                        </a>
                                    </li>
                                </ul>
                            </div>            
